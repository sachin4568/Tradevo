...
POST   /research/generate           → generate a research report
GET    /research                     → list research reports
GET    /research/prompts             → list available prompt templates
GET    /research/company/{company_id} → get latest report for a company
GET    /research/{report_id}         → get a specific report
...
@router.post(
    ...
    description=(
        ...
        "Uses the prompt registry to select the analysis template."
    ),
)
...
@router.get(
    ...
    description="Returns paginated list of user's research reports.",
)
...
@router.get(
    ...
    description="Returns all available AI prompt templates.",
)
...
@router.get(
    ...
    description="Returns the most recent research report for a specific company.",
)
...
@router.get(
    ...
    description="Returns a specific research report by ID.",
)
