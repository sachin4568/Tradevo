...
Manage the authenticated user's watchlist of tracked companies.
...
@router.get(
    ...
    description="Return all companies the user is watching with current price data.",
    responses={200: {"description": "Watchlist items"}, 401: {"description": "Unauthorized"}},
)
...
@router.post(
    ...
    description="Add a company to the user's watchlist. Optional notes can be attached.",
    responses={
        201: {"description": "Company added to watchlist"},
...
@router.delete(
    ...
    responses={
        200: {"description": "Company removed from watchlist"},
        401: {"description": "Unauthorized"},
