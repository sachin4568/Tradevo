    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-3">
          ...
          <button
            disabled
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-accent/15 bg-accent-subtle/40 py-2.5 text-[13.5px] font-semibold text-accent/40 cursor-not-allowed"
          >
